  ...
  return (
    <div
      ...
      className={cn(
        ...
        "glass glass-refraction glass-inner-shadow",
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-[var(--glass-border)] bg-[var(--glass-bg)] p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
